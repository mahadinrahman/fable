  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white p-6 md:p-10">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-8">
          <h3 className="text-xl font-bold tracking-tight text-zinc-100">Sales History</h3>
          <p className="text-sm text-zinc-500 mt-1">Track and manage your book sales and revenue.</p>
        </div>
            ...
            <tbody className="divide-y divide-zinc-800/60 text-sm">
              {sellerSales.length > 0 ? (
                sellerSales.map((sale) => (
                  ...
                  >
                    {/* Book Image & Name (bookImageIcon এখানে যুক্ত করা হয়েছে) */}
                    ...
                    {/* Genre Badge (bookGenre এখানে যুক্ত করা হয়েছে) */}
